...
if choice == "Home":
   st.subheader("Welcome To My 🔐 Secure Data Encryption ")
...
#   === data stroe section ===  
    ...
    if not st.session_state.authenticated_user:
        ...
        st.subheader("📦 Store Encrypyed Data")
        ...
        if st.button("Encrypt And save"):
            if data and passkey:
                ...
                stored_data[st.session_state.suthenticated_user]["data"].append(encrypted)
                save_data(stored_data)
