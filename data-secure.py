...
def generate_key(passkey):
    ...
    return base64.urlsafe_b64encode(key)  # ✅ Fix: encode, not decode
...
if choice == "Home":
    ...
    st.markdown("""
        - Store encrypted data using a unique passkey 🔏  
        - Decrypt using the correct passkey 🔓  
        - Lockout after 3 failed attempts 🚫  
        - No external DB — everything stays in memory 📁
    """)
